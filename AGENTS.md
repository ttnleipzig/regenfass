...
- **listmonk email templates**: whenever an email template is changed in listmonk, update the corresponding copy in `web/templates/email/` in the same change. Keep repository changes and the live listmonk templates synchronized in both directions.
