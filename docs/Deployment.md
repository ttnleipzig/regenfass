...
| Target                          | What                                                                                                                     | How                                                                                               |
| ------------------------------- | ------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------- |
| **Netlify** (preferred for web) | homepage → `regenfass.eu`, docs → `docs.regenfass.eu`, installer → `install.regenfass.eu` | **Built on GitHub Actions**, deployed with Netlify CLI — [Netlify Deployment](Netlify-Deployment) |
