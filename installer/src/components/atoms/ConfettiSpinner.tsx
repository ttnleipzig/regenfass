...
// https://codepen.io/zadvorsky/pen/OJwQxo
...
var viewWidth = 1024,
	...
	ctx: {
		...
		scale: (arg0: number, arg1: any) => void;
		fillStyle: string;
...
Particle = function (p0: any, p1: any, p2: any, p3: any) {
	this.p0 = p0;
	this.p1 = p1;
	this.p2 = p2;
	this.p3 = p3;
...
// pun intended
Exploader = function (x: any, y: any) {
	this.x = x;
	this.y = y;
...
var Ease = {
	...
	outCubic: function (t: number, b: number, c: number, d: number) {
		t /= d;
		t--;
		return c * (t * t * t + 1) + b;
	},
	inOutCubic: function (t: number, b: number, c: number, d: number) {
		t /= d / 2;
		if (t < 1) return (c / 2) * t * t * t + b;
		t -= 2;
		return (c / 2) * (t * t * t + 2) + b;
	},
	inBack: function (t: number, b: number, c: number, d: number, s: number) {
		s = s || 1.70158;
...
export default function Confetti() {
	return <canvas id="drawing_canvas"></canvas>;
}
