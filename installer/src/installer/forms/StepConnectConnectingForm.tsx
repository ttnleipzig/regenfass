...
const StepConnectConnectingForm: Component<StepConnectConnectingFormProps> = (props) => {
  const [selectedDevice, setSelectedDevice] = createSignal<DeviceType | undefined>();
  ...
  const handleConnect = async () => {
    ...
    try {
      ...
      props.send?.({ type: "connect.deviceType", deviceType: selectedDevice() });
    } catch (error) {
          ...
          <div class="flex">
            ...
            <div class="ml-3">
              ...
              <div class="mt-2 text-sm text-blue-700">
                <p>Stellen Sie sicher, dass Ihr Mikrocontroller über USB verbunden ist und wählen Sie den korrekten Typ aus.</p>
              </div>
            </div>
          </div>
        </div>
